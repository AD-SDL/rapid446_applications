...
config = {
    ...
    # 'combinations': [[2,10,18],[3,19,11],[12,20,4],[5,13,21]],
    #'combinations': [[2,10,18],[3,11,19],[4,12,20],[5,13,21]],  #2025-09-18 run04 printer dye
    'combinations': [[2,10,18],[3,11,19],[4,12,20],[5,13,21]],  #2025-09-19 run05 printer dye
