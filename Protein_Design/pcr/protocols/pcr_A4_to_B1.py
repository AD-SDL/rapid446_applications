...
def run(protocol: protocol_api.ProtocolContext):
    ...
    fragments_plate = protocol.load_labware('nest_96_wellplate_100ul_pcr_full_skirt', "A4")
    ...
    protocol.move_labware(labware=fragments_plate, new_location=temp_adapter_1, use_gripper=True)
