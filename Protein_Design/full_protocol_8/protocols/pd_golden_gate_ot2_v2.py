...
def run(protocol: protocol_api.ProtocolContext):
    ...
    # Pipettes
    p50 = protocol.load_instrument(config['pipette_type_20_multi'], mount='right', tip_racks=[tiprack_50_2])
    p50s = protocol.load_instrument(config['pipette_type_20'], mount='left', tip_racks=[tiprack_50_2])

    p50.configure_nozzle_layout(style='COLUMN', start='A1', tip_racks=[tiprack_50_2])
